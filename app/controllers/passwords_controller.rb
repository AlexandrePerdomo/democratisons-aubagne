class PasswordsController < ApplicationController
  ...
  def create
    uri = "#{default_url}/users/password"
  ...
  def update
    ...
    if retour_api[:success]
      flash[:notice] = "Le mot de passe a été modifié. Vous pouvez maintenant vous connecter avec vos nouveaux identifiants."
  ...
  protected
    ...
    def assert_reset_token_passed
      redirect_to "/connexion" if params[:reset_password_token].blank?
    end
